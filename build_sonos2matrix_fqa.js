...
const uiView = [
  ...
  row(button("destinationHue", "HUE", "0.33"), button("destinationVelux", "VELUX", "0.33"), button("destinationSonos", "SONOS", "0.34")),
  ...
  row(button("refresh", "Genindlæs enheder", "0.5"), button("clearSelections", "Nulstil valg", "0.5")),
  ...
  row(label("activeMappingStatus", "Aktiv mapping: Hue / vælg Hue / vælg Matrix")),
...
const callbacks = [
  ...
  { name: "destinationHue", callback: "destinationHue", eventType: "onReleased" },
  { name: "destinationHue", callback: "", eventType: "onLongPressDown" },
  { name: "destinationHue", callback: "", eventType: "onLongPressReleased" },
  { name: "destinationVelux", callback: "destinationVelux", eventType: "onReleased" },
  { name: "destinationVelux", callback: "", eventType: "onLongPressDown" },
  { name: "destinationVelux", callback: "", eventType: "onLongPressReleased" },
  { name: "destinationSonos", callback: "destinationSonos", eventType: "onReleased" },
  { name: "destinationSonos", callback: "", eventType: "onLongPressDown" },
  { name: "destinationSonos", callback: "", eventType: "onLongPressReleased" },
  ...
  { name: "clearSelections", callback: "clearCurrentSelections", eventType: "onReleased" },
  { name: "clearSelections", callback: "", eventType: "onLongPressDown" },
  { name: "clearSelections", callback: "", eventType: "onLongPressReleased" },
...
const fqa = {
  ...
  initialProperties: {
    ...
    quickAppVariables: [
      ...
      { name: "activeDestinationType", value: "yahue" },
